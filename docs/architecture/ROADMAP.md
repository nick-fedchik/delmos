...
| `v0.4.0` | P2 (частково) | CRUD Work Product 6 типів ядра з незмінними ревізіями та `payload_hash` | Реалізовано |
| `v0.5.0` | P6 (частково) | `RepositoryProvider`: чистий Git (локальний bare / SSH / HTTPS) | Реалізовано (bare/HTTPS; SSH — наступна ітерація) |
| `v0.6.0` | P7 (частково) | Мінімальний Web GUI для наскрізного сценарію `alpha` | Реалізовано (без дизайн-системи Pajamas) |
