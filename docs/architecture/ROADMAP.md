...
| --- | --- | --- | --- |
| `v0.1.0` | P0 | Збірка, конфігурація, міграції, тестова БД, `make validate`, `/healthz` | Наступна |
| `v0.2.0` | P1 (частково) | Облікові записи, вхід адміністратора, сесії, Scoped RBAC | Заплановано |
| `v0.3.0` | P1 | CRUD `Project` та атомарний `Generic Project Plan` (`PLAN-001`) | Заплановано |
