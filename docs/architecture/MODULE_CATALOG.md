...
Розділ розширює платформу функціоналом **Project ERP (PPM / PSA)** за міжнародними стандартами **PMBOK**, **SWEBOK**, **ISO 21502** та **ASPICE MAN.3**.
...
- **Призначення:** Наскрізне фінансове планування, затвердження бюджету (Cost Baseline за PMBOK / ISO 21502), облік прямих і накладних витрат (Labor & Non-Labor), аналіз ефективності за методом освоєного обсягу (EVM за SWEBOK) та P&L/TCO.
- **Внесок у Project Plan:**
