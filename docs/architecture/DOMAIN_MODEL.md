...
5. **Проєктна економіка та облік ресурсів:** Інженерна діяльність прив'язана до ресурсів (`WorkRecord`), місткості (`ResourceAllocation`), затвердженого бюджету (`CostBaseline`) та розрахунку освоєного обсягу (EVM: $PV, AC, EV, CPI, SPI$).
